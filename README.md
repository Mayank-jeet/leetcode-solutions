...
A collection of my LeetCode solutions written in C++ and organized by data structures, algorithms, and problem-solving patterns.
...
1525.Number_of_Good_Ways_to_Split_a_String.cpp
```
 ...
 * Link: [<problem-link>](<problem-link>)
 ...
 * Link: [https://leetcode.com/problems/number-of-good-ways-to-split-a-string/](https://leetcode.com/problems/number-of-good-ways-to-split-a-string/)
 * Difficulty: Medium
 * Time: O(n), where n is the size of the input string
 * Space: O(1), as the map stores at most 26 different lowercase English letters
 */
```
